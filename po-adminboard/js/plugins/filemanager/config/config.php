...
$strlink_po = preg_replace("/\/po-adminboard\/js\/plugins\/filemanager\/(dialog\.php$)/","",$str_po);
...
$upload_dir = $strlink_po."/po-content/po-upload/"; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../po-content/po-upload/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../po-content/po-thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$relative_image_creation_width          = array(640); //width of image (you can leave empty if you set height)
$relative_image_creation_height         = array(480); //height of image (you can leave empty if you set width)
/*
#             $option:     0 / exact = defined size;
#                          1 / portrait = keep aspect set height;
#                          2 / landscape = keep aspect set width;
