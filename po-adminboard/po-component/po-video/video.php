...
?>
	...
	<ul class="breadcrumb breadcrumb-top">
		...
		<li>Input, edit, view and delete video management</li>
	</ul>
<?php
switch($_GET[act]){
	default:
	...
	<div class="block full">
		<div class="block-title">
			...
			<div class="block-options pull-right">
				...
				<a href="admin.php?mod=video&act=album" class="btn btn-sm btn-success" title="Album"><i class="fa fa-picture-o"></i> Album</a>
			</div>
		</div>
			...
			<div class="modal-content">
				<form method="post" action="<?=$aksi;?>" autocomplete="off">
					...
					<div class="modal-body">
						<input type="hidden" name="mod" value="video">
						<input type="hidden" name="act" value="deletevideo">
...
?>
	<div class="block full">
		...
		<form id="form-validation" class="form-bordered" method="post" action="<?=$aksi;?>" autocomplete="off">
            <fieldset>
				<input type="hidden" name="mod" value="video">
				<input type="hidden" name="act" value="inputvideo">
				<?php
				...
				<div class="form-group">
					<label>Url Video <i>(Only Youtube Video)</i> <span class="text-danger">*</span></label>
