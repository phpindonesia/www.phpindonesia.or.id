                    ...
                    <div class="portfolio-container">
						...
						<div class="portfolio dt-sc-one-third column with-space">
                            ...
                            <div class="portfolio-thumb">
                                <img src="<?=$website_url;?>/po-content/po-upload/medium/medium_<?=$datavid->picture;?>" alt="<?=$dataalb->title;?>" />
                                <div class="image-overlay">
                                    <a class="link" href="<?=$website_url;?>/video/<?=$dataalb->seotitle;?>"><span class="fa fa-link"></span></a>
                                </div>
